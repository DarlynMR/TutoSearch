...
public class DownloadAdapter extends RecyclerView.Adapter<DownloadHolder> {
    ...
    TransmisionLive transmisionLive;
    List<DownloadModel> mListDownload;
    String linkDown,idTuto;

    public DownloadAdapter(TransmisionLive transmisionLive, ArrayList<DownloadModel> downloadModels) {
        this.transmisionLive = transmisionLive;
    ...
    public void onBindViewHolder(@NonNull final DownloadHolder holder, final int position) {
        ...
        holder.btnDescargar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fileC.exists()){
                    Toast.makeText(holder.filename.getContext(), "Este archivo ya se ha descargado", Toast.LENGTH_SHORT).show();
                }else{
